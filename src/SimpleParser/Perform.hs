...
performParserT :: Monad m => ParserT l s e m a -> s -> m (Either (NESeq (AnchoredParseError l s e)) (Maybe a))
...
performParser :: Parser l s e a -> s -> Either (NESeq (AnchoredParseError l s e)) (Maybe a)
